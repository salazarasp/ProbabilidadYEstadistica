...
alabels_final=[allplaces.index[i]+" "+"{:0.3f}".format(allplaces[i]/data["sector"].size*100)+ "%"for i in range (allplaces.size)]
alabels_lscommon=[less_common.index[i]+" "+"{:0.3f}".format(less_common[i]/data["sector"].size*100)+ "%"for i in range(less_common.size)]
alabels_vul=[rare.index[i]+" "+"{:0.4f}".format(rare[i]/data["sector"].size*100)+ "%"for i in range(rare.size)]
